...
using TrelloAutomation.API.API.Common.Attributes;
using TrelloAutomation.API.API.Common.Middlewares;
using TrelloAutomation.API.API.Common.Settings;
using TrelloAutomation.API.API.Swagger;
using TrelloAutomation.API.IoC.Configuration.DI;

#pragma warning disable CS1591
namespace TrelloAutomation.API.API
{
